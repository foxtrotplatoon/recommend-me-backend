...
Recc.create!(name: "Weird Tree in the Park", description: "Come check out this weird tree I found.", location: "41.879591, -87.650078", owner: User.find(1))

Recc.create!(name: "Tall Tower in Chicago", description: "Anyone else notice this big tower here?", location: "Willis Tower", owner: User.find(2))

Recc.create!(name: "Chicago Navy Pier", description: "This place is great! Treats, games, prizes, and a Ferris Wheel!", location: "Navy Pier", owner: User.find(2))

Recc.create!(name: "8th Light", description: "A wonderful office full of wonderful coders.", location: "25 E Washington St #509, Chicago, IL 60602", owner: User.find(3))

Recc.create!(name: "Jay Pritzker Pavilion", description: "What a wonderful view walking up Washington!", location: "201 E Randolph St, Chicago, IL 60601
